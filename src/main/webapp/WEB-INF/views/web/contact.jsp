...
<c:url var="customerAPI" value="/customer"/>
...
<div class="page-wrapper">
    ...
    <div class="box-lienhe mt-5">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6">
                    <h2 class="title-lienhe"><strong>Công ty cổ phần bất động sản SkyLand</strong>
                    </h2>
                    <div class="desc-lienhe">
                        <p>Được thành lập vào ngày 20/08/2008 với niềm đam mê và khát vọng thành
                            công trong lĩnh vực
                            bất động sản. Nhờ chiến lược rõ ràng và hướng đi đúng, SkyLand đã nhanh
                            chóng phát triển
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form:form modelAttribute="customerInfor" id="formCustomerInfor" method="GET">
                        <div class="row">
                            <div class="col">
                        ...
                        <form:input path="phone" class="form-control mt-3"
                                    placeholder="Số điện thoại"/>
                        <form:input path="note" class="form-control mt-3" placeholder="Nội dung"/>
                        <button class="btn btn-primary px-4 mt-3" id="btnContact">
                            Gửi liên hệ
                        </button>
                    </form:form>
                </div>
            ...
            <div class="top-footer text-center mt-0">
                <div class="logo logo-footer pt-5">
                    <a href="./ViewHome.html"><img
                            ...
                            alt="logo-footer"></a>
                    <p class="desc-logo-footer mt-3">Với hơn 10 năm kinh nghiệm, SkyLand tự hào là
                        sàn
                        mua
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 text-center">
                                ...
                                <div class="content-center-footer">
                                    ...
                                    <p class="desc-footer"><a class="a-text"
                ...
                <div class="row">
                    <div class="col-12 col-md-3">
                        ...
                        <p class="desc-item-bottom-footer desc-1"><a class="a-text" href="">Trang
                            chủ</a></p>
                        <p class="desc-item-bottom-footer"><a class="a-text" href="">Giới thiệu</a>
                        </p>
...
<script>
  $('#btnContact').click(function (e) {
    e.preventDefault();
    var data = {};
    var formData = $('#formCustomerInfor').serializeArray();
    ...
    if (data['fullName'] != '' && data['phone'] != '') {
      ...
      window.location.href = "<c:url value="/lien-he?fullName=required&phone=required"/>";
    }
  })
  ...
  function addCustomer(data) {
    $.ajax({
      ...
      success: function (response) {
        window.location.href = "<c:url value="/lien-he?success=success"/>";
      },
      error: function (response) {
        window.location.href = "<c:url value="/lien-he?error=error"/>";
      }
    })
  }
</script>
