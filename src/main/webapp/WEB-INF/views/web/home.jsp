                                        ...
                                        <div class="row section-why">
                                                ...
                                                <div class="wrap-temp d-flex">
                                                    <div class="ico">
                                                        <img class="img-responsive lazyload loaded"
                                                             ...
                                                             data-src=""
                                                             alt="Chất lượng tốt nhất"
                                                             data-was-processed="true">
                                                    </div>
                                                    <div class="content_p ml-4">
                                                        <h4><a href="#" class="why-title a-text">Chất
                                                            lượng
                                                            tốt nhất</a>
                                                        </h4>
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="wrap-temp d-flex">
                                                    ...
                                                    <div class="content_p ml-4">
                                                        <h4><a href="#" class="why-title a-text">Tìm
                                                            kiếm
                                                            thông tin dễ
                                                            dàng</a></h4>
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="wrap-temp d-flex">
                                                    ...
                                                    <div class="content_p ml-4">
                                                        <h4><a href="#" class="why-title a-text">Kết
                                                            nối
                                                            với nhà đầu tư</a>
                                                        </h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="wrap-temp d-flex">
                                                ...
                                                <div class="content_p ml-4">
                                                    <h4><a href="#" class="why-title a-text">Đảm bảo
                                                        quyền
                                                        lợi khách
                                                        hàng</a></h4>
                                                    <p>
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="wrap-temp d-flex">
                                                ...
                                                <div class="content_p ml-4">
                                                    <h4><a href="#" class="why-title a-text">Tiết
                                                        kiệm thời
                                                        gian và chi
                                                        phí</a></h4>
                                ...
                                <div class="inner-get">
                                    <div class="form-inner">
                                        <form class="a-center"
                                            ...
                                            <button class="button-subscribe button-45 subscribe"
                                                    name="subscribe"
                ...
                <div class="top-footer text-center mt-0">
                    <div class="logo logo-footer pt-5">
                        <a href="./ViewHome.html"><img
                                ...
                                alt="logo-footer"></a>
                        <p class="desc-logo-footer mt-3">Với hơn 10 năm kinh nghiệm, SkyLand tự hào
                            là sàn
                            mua
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4 text-center">
                                    ...
                                    <div class="content-center-footer">
                                        ...
                                        <p class="desc-footer">Số 46 Man Thiện, TP Thủ Đức, TP
                                            HCM</p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 text-center">
                                    ...
                                    <div class="content-center-footer">
                                        ...
                                        <p class="desc-footer"><a class="a-text" href="#">098828</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 text-center">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-3">
                            ...
                            <p class="desc-item-bottom-footer desc-1"><a class="a-text" href="">Trang
                                chủ</a></p>
                            <p class="desc-item-bottom-footer"><a class="a-text" href="">Giới
                                thiệu</a></p>
                            <p class="desc-item-bottom-footer"><a class="a-text" href="">Dự án bất
                                động
                                sản</a></p>
                            <p class="desc-item-bottom-footer"><a class="a-text" href="">Tin tức</a>
                            </p>
                            <p class="desc-item-bottom-footer"><a class="a-text" href="">Liên hệ</a>
                            </p>
                        </div>
                        <div class="col-12 col-md-3">
...
<section class="gradient-custom form-register">
                    ...
                    <div class="card-body p-2 px-5 text-center">
                        <div class="md-5 md-4 mt-4 pb-2">
                            ...
                            <div class="form-outline form-white mb-2">
                                ...
                                <input type="email" id="typePasswordX"
                                       class="form-control form-control-lg"/>
                            </div>
                            ...
                            <p class="text-center text-muted mt-2 mb-0">Have already an account? <a
                                    href="#!"
                                    class="fw-bold text-body"><u style="color: white ;">Login
                                here</u></a></p>
