...
import com.javaweb.converter.user.UserConverter;
...
public class UserService implements IUserService {
  ...
  public Map<Long, String> getStaffs() {
    ...
    for (UserEntity staff : staffs) {
      staffList.put(staff.getId(), staff.getFullName());
    }
    return staffList;
  }
  ...
  public int getTotalItems(String searchValue) {
    int totalItem = 0;
    if (StringUtils.isNotBlank(searchValue)) {
      totalItem = (int) userRepository.countByUserNameContainingIgnoreCaseOrFullNameContainingIgnoreCaseAndStatusNot(
